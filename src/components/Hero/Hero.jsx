...
const HeroSection = () => {
  return (
    <div className="relative bg-gradient-to-r from-[#007BFF] to-[#10B981] text-white pt-40 md:pt-46 pb-30 px-5" style={{
    ...
    backgroundRepeat: "no-repeat",
      ...
      <div className="container mx-auto flex justify-center text-center md:text-left pt-16">
  ...
  Welcome to <span className="text-[#FFD700] drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">ZahraITDev</span>
</h1>
<motion.p
  className="text-base text-white md:text-xl mt-3"
  initial={{ opacity: 0 }}
  animate={{ opacity: 1 }}
...
>
  ...
  specializing in
  <span className="font-semibold text-[#00CFFF] drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">
    {" "}Web Development
  </span>{" "}
  and
  <span className="font-semibold text-[#FF3B3B] drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">
    {" "}Digital Marketing
    </span>
  ...
  growth-focused digital strategies to elevate your brand.
          ...
          <div className="mt-6 flex justify-center space-x-4">
            <Link to="/contact">
              <motion.button
                className="px-2 md:px-6 py-1 md:py-3 bg-[#FFD700] font-medium text-block rounded shadow-lg hover:bg-yellow-300"
