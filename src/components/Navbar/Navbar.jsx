...
>
  <svg className="text-4xl font-black"
    width="100"
    height="60"
    viewBox="0 0 100 60"
  ...
  <h1
    className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#007BFF] to-[#10B981]"
  ...
  ZAHRAITDEV
        ...
        <ul className="hidden md:flex space-x-8 items-center">
          {navLinks.map((link) => (
           ...
           <li>
            <Link to="/getaquote" className="bg-gradient-to-r from-blue-600 to-[#10B981] text-white px-5 py-2 rounded-xl text-base font-semibold hover:from-blue-700 hover:to-teal-600 transition-all shadow-md"
            >
              Get a Quote
            </Link>
          </li>
